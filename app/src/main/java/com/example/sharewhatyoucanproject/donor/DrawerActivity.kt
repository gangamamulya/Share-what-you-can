...
import com.example.sharewhatyoucanproject.RequestActivity
import com.example.sharewhatyoucanproject.UserActivity
...
class DrawerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigationView1.menu.getItem(4).setOnMenuItemClickListener {
            val i = Intent(this@DrawerActivity, DrawerActivity::class.java)
            drawerLayout.closeDrawers()
            startActivity(i)
            false
        }
